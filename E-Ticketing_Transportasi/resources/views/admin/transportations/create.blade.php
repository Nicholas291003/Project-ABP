...
<div class="flex-1 overflow-y-auto p-6 lg:p-8 bg-gray-50 pb-24">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah Data Transportasi</h1>
            <p class="text-sm text-gray-500 mt-1">Masukkan detail armada baru yang akan beroperasi.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8 max-w-4xl">
        <form action="{{ route('admin.transportations.store') }}" method="POST">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                <button type="reset" class="px-5 py-2.5 text-gray-600 font-medium hover:bg-gray-100 rounded-lg transition">
                    Reset Form
                </button>
